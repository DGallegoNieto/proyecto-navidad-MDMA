...
Hemos creado una página web de un concesionario de coches. Tiene un inicio en el que se puede registrar como usuario o crear uno si no tiene. 

También tenemos un apartado de los coches más vendidos o la opción de personalizar el coche a su gusto, eligiendo entre una serie opciones.
Hemos puesto un menú para que el usuario pueda acceder de una forma más sencilla a éstas opciones.
